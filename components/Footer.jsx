...
export default function Footer() {
    return (
        <footer className="relative w-full h-[75vh] overflow-hidden bg-black text-white border-t border-white/20">
            {/* Background Video */}
            <video
            ...
            {/* Overlay content */}
            <div className="relative z-10 w-full h-full flex flex-col justify-between px-6 py-8 md:px-12 md:py-12">

                <div className="flex-1 flex items-center">
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-light tracking-tight font-[family-name:var(--font-outfit)]">
                        Let&rsquo;s build what&rsquo;s next, <span className="text-white">together.</span>
                    </h1>
                </div>

                {/* Bottom Navigation & Socials */}
                <div className="w-full flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-0 border-t border-white/20 pt-8 mt-8 md:border-none md:pt-0 md:mt-0">

                    {/* Logo & Links Group */}
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12">
                        {/* Logo */}
                        <Link href="/" className="hover:opacity-80 transition-opacity">
                            <img src="/zenithcode_logo.png" alt="ZenithCode Logo" className="h-14 w-auto object-contain mix-blend-screen" />
                        </Link>

                        {/* Navigation Links */}
                        <nav className="flex flex-wrap gap-6 md:gap-8 text-sm md:text-base font-[family-name:var(--font-manrope)] tracking-wide">
                            <Link href="/what-we-do" className="hover:text-gray-300 transition-colors">What we do</Link>
                            ...
                            <Link href="/solution" className="hover:text-gray-300 transition-colors">Our solution</Link>
                        </nav>
                    </div>
